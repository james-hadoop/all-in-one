...
//        String sqlString = SQLUtils.toSQLString(statementList, dbType);
//        System.out.println("sqlString: " + sqlString);

//        SQLExpr expr = SQLUtils.toMySqlExpr(sql);

//        SQLEvalVisitorImpl visitor=new SQLEvalVisitorImpl();

//        Map<String, Object> attrMap = expr.getAttributes();
//
//        JamesUtil.printMap(attrMap);
//        
//        expr.getChildren();
    }
