...
public class HiveTableLineageParserBriefTemp9 {
	/*
	 * TableRelation
	 */
	...
	public static void main(String[] args) throws IOException {
		...
		HiveTableLineageParserBriefTemp9.parse(ast);
...
//									System.out.println("\t\t\t" + SqlLineageUtil.replaceWithSrcTableName(i3, tableAliasLineageMap));
									referTableFieldSet.add(SqlLineageUtil.replaceWithSrcTableName(i3, tableAliasLineageMap));
								}
							}
						}
					}
