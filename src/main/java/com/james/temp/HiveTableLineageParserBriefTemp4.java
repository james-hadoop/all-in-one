...
public class HiveTableLineageParserBriefTemp4 {
    /*
     * TableRelation
     */
    ...
    public void parseIteral(ASTNode ast) {
        parseChildNodes(ast);
    ...
    public static void main(String[] args) {
        ...
        HiveTableLineageParserBriefTemp4 hp = new HiveTableLineageParserBriefTemp4();
        ...
        for (Entry<String, String> e : map1st.entrySet()) {
            System.out.println(e.getKey() + " -> " + e.getValue() + " -> "
                    + SqlLineageUtil.replaceWithSrcTableName(e.getValue(), tableAliasLineageMap));
        }
    }
}