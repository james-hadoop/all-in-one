...
public class HiveTableLineageParserBriefTemp5 {
	...
	public static void main(String[] args) {
		...
		HiveTableLineageParserBriefTemp5 hp = new HiveTableLineageParserBriefTemp5();
		...
		if (0 == insertSelectFieldMap.size()) {
			...
			Set<String> aliasFieldSet = fieldAliasMap2.keySet();
			for (String k : aliasFieldSet) {
				if (k.contains(outerTable)) {
					insertSelectFieldMap.put(k, fieldAliasMap2.get(k));
				}
			}
		}
